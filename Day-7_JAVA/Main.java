...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("2️⃣ Search Employee");
            System.out.println("3️⃣ Update Salary");
            System.out.println("4️⃣ Delete Employee");
            System.out.println("5️⃣ View All Employees");
